...
for filename, url in rbtray_files.items():
    download_file(url, rbtray_dir / filename)
...
# 6. Add AHK and Python script to startup (no shortcut)
try:
    shutil.copy(project_folder / "Downloader.ahk", startup_dir / "Downloader.ahk")
    print(f"Copied Downloader.ahk to startup folder.")
except Exception as e:
    print(f"Could not copy Downloader.ahk: {e}")

try:
    shutil.copy(project_folder / "ytlinkserver.py", startup_dir / "ytlinkserver.py")
    print(f"Copied ytlinkserver.py to startup folder.")
except Exception as e:
    print(f"Could not copy ytlinkserver.py: {e}")
